...
class Centro(models.Model):
    ...
    email_decano = models.EmailField(blank=True, null=True)
    ...
    email_secretario = models.EmailField(blank=True, null=True)
...
class Departamento(models.Model):
    ...
    email = models.EmailField(_("email address"), blank=True, null=True)
    email_secretaria = models.EmailField(blank=True, null=True)
    ...
    email_director = models.EmailField(blank=True, null=True)
