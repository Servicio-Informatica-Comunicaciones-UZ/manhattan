        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nip_coord_pou",
                    models.PositiveIntegerField(
                        blank=True, null=True, verbose_name="NIP del coordinador POU"
                    ),
                ),
                (
                    "nombre_coord_pou",
                    models.CharField(
                        ...
                        max_length=255,
                        null=True,
                        verbose_name="nombre del coordinador POU",
                    ),
                ),
                (
                    "email_coord_pou",
                    models.EmailField(
                        ...
                        max_length=254,
                        null=True,
                        verbose_name="email del coordinador POU",
                    ),
                ),
                (
                    "esta_activo",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "financiacion",
                    models.TextField(
                        blank=True, null=True, verbose_name="Financiación solicitada"
                    ),
                ),
                (
                    "ayuda",
                    models.PositiveIntegerField(
                        blank=True, null=True, verbose_name="Ayuda solicitada"
                    ),
                ),
                (
                    "centro",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        limit_choices_to=models.Q(programa__convocatoria_id=2019),
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        to="indo.Linea",
                        verbose_name="Línea",
                ...
                (
                    "programa",
                    models.ForeignKey(
                        limit_choices_to={"convocatoria_id": 2019},
                        on_delete=django.db.models.deletion.PROTECT,
                        to="indo.Programa",
                    ),
                ),
