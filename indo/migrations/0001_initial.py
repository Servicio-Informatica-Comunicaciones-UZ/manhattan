# Generated by Django 2.1 on 2019-03-11 12:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(blank=True, max_length=254, null=True, verbose_name='correo electrónico')),
                ...
                ('email_decano', models.CharField(blank=True, max_length=254, null=True)),
                ...
                ('email_secretario', models.CharField(blank=True, max_length=254, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(blank=True, max_length=254, null=True, verbose_name='correo electrónico')),
                ('email_secretaria', models.CharField(blank=True, max_length=254, null=True)),
                ...
                ('email_director', models.CharField(blank=True, max_length=254, null=True)),
            ],
        ),
        migrations.AddIndex(
            model_name='centro',
        ...
        migrations.AddIndex(
            model_name='centro',
            index=models.Index(fields=['rrhh_id_nk'], name='indo_centro_rrhh_id_7654d0_idx'),
        ),
    ]
